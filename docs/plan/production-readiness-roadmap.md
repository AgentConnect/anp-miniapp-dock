...
| 03-03 | 权限策略引擎与 allowlist decision | 01-08, 02-05, 03-01 | `PermissionDecision`、Host override、network allowlist、decision audit | [production-readiness/steps/03-03-permission-policy-engine-allowlist.md](production-readiness/steps/03-03-permission-policy-engine-allowlist.md) | 必须 | review |
