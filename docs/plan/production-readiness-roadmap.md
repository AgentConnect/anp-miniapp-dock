...
| 03-02 | QuickJS 沙箱逃逸回归与资源限制 | 02-05, 03-01 | API VM / Component VM sandbox escape tests、resource limits | [production-readiness/steps/03-02-quickjs-sandbox-resource-limits.md](production-readiness/steps/03-02-quickjs-sandbox-resource-limits.md) | 必须 | review |
