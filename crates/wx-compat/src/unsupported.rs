...
pub const UNSUPPORTED_WX_APIS: &[UnsupportedApi] = &[
    ...
    UnsupportedApi {
        ...
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Configure a phone provider with ConsentGate, audit, and redaction.",
    },
    UnsupportedApi {
        name: "chooseAddress",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host address provider or render a manual address form fallback.",
    },
    UnsupportedApi {
        name: "getLocation",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host location provider with consent and prefer minimized location.",
    },
    UnsupportedApi {
        name: "getFuzzyLocation",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host location provider with consent and redacted audit.",
    },
    UnsupportedApi {
        name: "chooseLocation",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host location picker with explicit user consent.",
    },
    UnsupportedApi {
        name: "chooseMedia",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host media picker that returns opaque handles, not local file paths.",
    },
    UnsupportedApi {
        name: "chooseMessageFile",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host file picker that returns opaque handles, not local file paths.",
    },
    UnsupportedApi {
        name: "requestPayment",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Payment Intent provider with ConsentGate and merchant-side audit.",
    },
    UnsupportedApi {
        name: "requestVirtualPayment",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host payment provider with ConsentGate and merchant-side audit.",
    },
    UnsupportedApi {
    ...
    UnsupportedApi {
        ...
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host scan provider with explicit user action and redacted audit.",
    },
    UnsupportedApi {
        name: "makePhoneCall",
        kind: UnsupportedApiKind::Async,
        reason: HOST_PROVIDER_REASON,
        suggestion: "Use a Host phone-call provider with explicit user consent.",
    },
    UnsupportedApi {
        name: "authorize",
        kind: UnsupportedApiKind::Async,
